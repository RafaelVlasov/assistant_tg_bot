...
def helper(message):
    help_message = '<b>/help</b> - вывести справку по функциональностям\n<b>/view_words</b> - показать список ' \
                   ...
                   'задачи\"</b> - добавить задачу в список дел\n<b>del_word \"слово\"</b> - удалить слово из ' \
                   'временного массива\n<b>del_dict \"слово\"</b> - удалить слово и его описание из словаря\n' \
                   '<b>del_todo \"номер задачи\"</b> - удалить задачу под указанным номером из списка дел\n' \
